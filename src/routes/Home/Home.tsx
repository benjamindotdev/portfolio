        ...
        <>
            ...
            <PageContainer id="home" layout="hero">
                <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12 w-full">
                    <div className="flex flex-col gap-10 md:gap-12 w-full md:w-2/3 text-left">
                        <h1 className="p-0 m-0 text-3xl md:text-5xl lg:text-6xl text-portfolio-cyan font-satoshi font-bold tracking-wide whitespace-normal md:whitespace-nowrap">
                    ...
                    <div className="w-2/4 md:w-1/3 aspect-square">
